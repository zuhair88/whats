...
client.on('ready', () => {
  console.log('Client is ready!');
   ...
   // Number where you want to send the message. (+60)

  //const number = "+60186643475";
  const number = "+60183574749";
  //const number = "+60177134786";
   // Your message.
  const text = "Test";
  ...
  client.isRegisteredUser(chatId).then(function(isRegistered) {
     if(isRegistered) {
      ...
      console.log("Not registered with WhatsApp!");
     }
   })  
...
//______________________________________________________________________________________
 //// Check if register with whatsapp
